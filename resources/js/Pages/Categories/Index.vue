<template>
    <pageTitle title="الاقسام الرئيسية" />
            ...
            <div class="grid lg:grid-cols-12 w-full">
                <div class="lg:col-start-4 lg:col-end-13 lg:mx-2 table-responsive">
                    ...
                    <div class="mb-3 mx-3">
                        ...
                        <inertia-link href="/categories/create" type="submit" class="btn btn-outline-primary text-white float-left px-3 flex">
                            ...
                            <span class="mx-2 text-xs">اضافة قسم رئيسي</span>
                        </inertia-link>
                    </div>
                    <div v-if="categories.data.length > 0" class="border border-white">
                        <table class="table table-dark table-hover table-striped text-center text-white table-fixed align-middle">
                            <thead>
                                <tr class="text-muted">
                                    <th>
                                        <inertia-link class="flex justify-center" href="#" @click="sort('cat_name')">اسم القسم
                    ...
                    <div v-else class="text-center mt-5">
                        ...
                        <inertia-link class="lead text-decoration-none text-blue-300 hover:text-yellow-400 transition duration-500" href="/categories/create">اضغط هنا لانشاء قسم جديد</inertia-link>
                    </div>
                    <!--  Pagination  -->
