                ...
                <div class="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
                    <div class="flex flex-col text-center">
                        ...
                        <div class="flex justify-center mt-4">
                            ...
                            <!-- whatsapp -->
                            <a class="text-gray-400 hover:text-green-600 mx-3 hvr-bounce-in transition duration-500" href="https://api.whatsapp.com/send?phone=9647733111109&fbclid=IwAR0-qKWSYKYPWw8TawqNLTof74DL593ODaisnAujEW9M5Skh_1S-RB7EC9g" target="_blank">
                            ...
                            <!-- youtube -->
                            <a class="text-gray-400 hover:text-red-600 mx-3 hvr-bounce-in transition duration-500" href="https://www.youtube.com/channel/UCnvWg0g2g_dSxR09pjnzKkQ" target="_blank">
                            ...
                            <!-- instagram -->
                            <a class="text-gray-400 hover:text-red-600 mx-3 hvr-bounce-in transition duration-500" href="https://www.instagram.com/micro_store5/" target="_blank">
                            ...
                            <a class="mx-3" href="tel:+9647733111109"><fa icon="phone" class="text-3xl hvr-bounce-in text-gray-400 hover:text-blue-500 transition duration-500" /></a>
                        </div>
                    </div>
                    <div class="flex flex-col">
                        ...
                        <span class="my-1"><inertia-link href="/cart" class="text-gray-500  text-md hover:text-yellow-500 transition duration-500">السلة</inertia-link></span>
                        <span class="my-1"><inertia-link href="/state" class="text-gray-500 text-md hover:text-yellow-500 transition duration-500">التحقق من الطلب</inertia-link></span>
