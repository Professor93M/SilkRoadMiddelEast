    ...
    <Disclosure id="nav" as="nav" class="bg-gray-800 sticky top-0 z-50" v-slot="{ open }">
        ...
        <div class="grid lg:grid-cols-3 lg:gap-3 gap-1 grid-cols-1 items-center justify-center lg:h-20">
            <div class="flex items-center justify-center lg:justify-start lg:col-start-1 lg:col-end-2 my-1 lg:my-auto">
                ...
                <div class="flex-shrink-0 flex items-center px-3 ">
                    ...
                    <inertia-link href="/" class="font-extrabold text-gray-400 text-2xl font-mono filter drop-shadow-lg hover:text-gray-100 transition duration-500">Micro Store</inertia-link>
            ...
            <div class="hidden lg:block col-start-9 col-end-13 ml-3">
                <div class="flex">
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 lg:static lg:inset-auto lg:pr-0">
                        <inertia-link href="/" title="الرئيسية" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
                        ...
                        <inertia-link href="/category"  title="الاقسام" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
                        ...
                        <inertia-link href="/product" title="السلع" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
                        ...
                        <inertia-link href="/special" title="السلع المميزة" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
                        ...
                        <inertia-link href="/cart" title="السلة" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
                        ...
                        <inertia-link href="/likes" title="المفضلة" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
                        ...
                        <inertia-link href="/state" title="تحقق من الطلب" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="h-6 w-6" viewBox="0 0 16 16">
                                <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                            </svg>
                        </inertia-link>

                        <inertia-link href="/contact" title="للتواصل معنا" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </inertia-link>

                        <inertia-link v-if="logged" href="/dashboard" title="لوحة التحكم" class="mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 transform hover:scale-105 motion-reduce:transform-none transition duration-500">
        ...
        <DisclosurePanel class="lg:hidden">
            <div class="flex flex-col px-2 pt-2 pb-3 space-y-3">
                ...
                <!-- <inertia-link href="/cart" class="cursor-pointer hover:bg-gray-600 flex mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-cart3 mx-3" viewBox="0 0 16 16">
                        <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                    </svg>
                ...
                <!-- <inertia-link href="/likes" class="cursor-pointer hover:bg-gray-600 flex mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-heart mx-3" viewBox="0 0 16 16">
                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
                    </svg>
                    <span v-if="this.$store.state.like.length > 0" class="position-absolute left-10 translate-middle badge rounded-pill bg-danger">
                        {{this.$store.state.like.length > 99 ? '+99' : this.$store.state.like.length}}
                        <span class="visually-hidden">cartCount</span>
                    </span>
                    المفضلة
                ...
                <!-- <inertia-link href="/state" class="cursor-pointer hover:bg-gray-600 flex mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="h-6 w-6 mx-3" viewBox="0 0 16 16">
                        <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                    </svg>
                    تحقق من الطلب
                </inertia-link> -->

                <inertia-link href="/contact" class="cursor-pointer hover:bg-gray-600 flex mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-info-circle mx-3" viewBox="0 0 16 16">
                ...
                <!-- <inertia-link v-if="logged" href="/dashboard" class="cursor-pointer hover:bg-gray-600 flex mx-1 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800">
                    <fa icon="cog" class="text-xl text-yellow-300 mx-3" />
                    لوحة التحكم
                </inertia-link> -->
            </div>
        </DisclosurePanel>
